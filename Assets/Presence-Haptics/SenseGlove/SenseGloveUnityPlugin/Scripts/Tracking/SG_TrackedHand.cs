...
namespace SG
{
	...
	public class SG_TrackedHand : MonoBehaviour, IHandPoseProvider, IHandFeedbackDevice
    {
        ...
        {
            Debug.LogError("QueueFFBCmd is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Force Effect");
...
#pragma warning restore CS0618 // Type or member is obsolete
        {
            Debug.LogError("SendLegacyWaveform is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Vibrotactile Effect");
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            Debug.LogError("SendImpactVibration is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Vibrotactile Effect");
            if (HapticHardware != null)
            {
        ...
        {
            Debug.LogError("SendCustomWaveform is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Vibrotactile Effect");
        ...
        {
            Debug.LogError("SetFlexionLocks is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Stiffness Effect");
            if (this.HapticHardware != null)
            {
        ...
        {
            Debug.LogError("QueueWristSqueeze is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Force Effect on the Hand Palm");
            if (this.HapticHardware != null)
            {
        ...
        {
            Debug.LogError("SendVibrationCmd is part of the SenseGlove Plugin. You might want to use PHap_Core instead! You're looking to make a Vibrotactile Effect");
            if (this.HapticHardware != null)
            {
