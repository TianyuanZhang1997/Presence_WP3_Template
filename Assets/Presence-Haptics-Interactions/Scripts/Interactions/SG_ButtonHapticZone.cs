...
namespace Presence
{
...
#if UNITY_EDITOR
    [CustomEditor(typeof(SG_ButtonHapticZone)), CanEditMultipleObjects]
    public class SG_ButtonLargeEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();

            SG_ButtonHapticZone button = target as SG_ButtonHapticZone;
    ...
    [System.Serializable]
    public class SG_ButtonHapticZonePressedEvent : UnityEngine.Events.UnityEvent<bool> { }

    public class SG_ButtonHapticZone : MonoBehaviour
    {
        ...
        public SG_ButtonHapticZonePressedEvent buttonPressed = new SG_ButtonHapticZonePressedEvent();
        ...
        public PHap_ReceiverDetector detector;
        ...
        {
            detector.PlayHapticEffect(hapticEffect, button.transform.position, 1);
        }
